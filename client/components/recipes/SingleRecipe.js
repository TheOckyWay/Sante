						...
						<Stack>
							<Stack>
								...
								>
									<DialogTitle
										sx={{
											backgroundColor: "rgba(156 163 175 50)",
											alignItems: "center",
											p: 1,
											m: 1,
											textAlign: "center",
									...
									>
										<span className="linkColor">{name}</span> was successfully
										added to today's tracker!
									</DialogTitle>
									...
									<Box gridColumn="span 2" justifyContent="space-around">
										...
										>
											<Typography variant="h6" color="rgb(156 163 175)">
												Cooking Time:{" "}
												<span className="yellowcolor">{cookTime}Mins</span>
											</Typography>
										</Card>
										<Card
											sx={{
										...
										>
											<Typography variant="h6" color="rgb(156 163 175)">
												Calories:{" "}
												<span className="yellowcolor">{calories}Cal</span>
											</Typography>
										</Card>
										...
										>
											<Typography variant="h6" color="rgb(156 163 175)">
												Carbohydrates:{" "}
												<span className="yellowcolor">{carbs}g</span>
											</Typography>
										</Card>
