...
async function seed() {
  ...
  const users = await Promise.all([
    ...
    User.create({ username: "Prince", password: "123", firstName: 'Prince', lastName: 'Karim', location: 'Queens, NY', email: 'prince@fullstack.com', age: 25, sex: 'male', currentHeight: 60, currentWeight: 250, targetWeight: 200, startingWeight: 250, targetWater: 4000, activityFactor: 'Lightly Active',targetChange:'Lose Weight',}),
    User.create({ username: "Alvin", password: "123", firstName: 'Alvin', lastName: 'Espinal', location: 'New York, NY', email: 'alvin@fs.com', age: 25, sex: 'male', currentHeight: 60, currentWeight: 250, targetWeight: 200, startingWeight: 250, targetWater: 4000, activityFactor: 'Lightly Active',targetChange:'Lose Weight',}),
    User.create({ username: "Andrew", password: "123", firstName: 'Andrew', lastName: 'Espinal', location: 'Queens, NY', email: 'andrew@fs.com', age: 25, sex: 'male', currentHeight: 60, currentWeight: 250, targetWeight: 200, startingWeight: 250, targetWater: 4000, activityFactor: 'Lightly Active',targetChange:'Lose Weight',}),
  ]);
