...
async function seed() {
  ...
  const users = await Promise.all([
    User.create({ username: "Hamza", password: "123", firstName: 'Muhammad', lastName: 'Hamza', location: 'Queens, NY', email: 'hamza@foo.com', age: 25, sex: 'male', currentHeight: 60, currentWeight: 250, targetWeight: 200, startingWeight: 250, targetCalories:2500, targetWater: 4000, activityFactor: 'Lightly Active',targetChange:'Lose Weight',}),
